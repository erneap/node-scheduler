...
@Component({
  selector: 'app-employee-specialties-editor',
  imports: [
    MatIconModule,
    ListMultiple
  ],
  templateUrl: './employee-specialties-editor.html',
  styleUrl: './employee-specialties-editor.scss',
})
export class EmployeeSpecialtiesEditor {

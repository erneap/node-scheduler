...
import { ErrorMessage } from '../../../../team/team-editor/team-editor-sites/team-editor-site-new/team-editor-site-new';
import { NewSitePersonnel } from 'scheduler-models/scheduler/sites/web';
import { PersonelData } from '../../../../team/team-editor/team-editor-sites/team-editor-site-new/team-editor-site-new-personnel/team-editor-site-new-personnel';
import { Item } from '../../../../general/list/list.model';

@Component({
  selector: 'app-admin-teams-new-personnel',
  imports: [
    List,
    FormField,
    MatFormFieldModule,
  ...
  templateUrl: './admin-teams-new-personnel.html',
  styleUrl: './admin-teams-new-personnel.scss',
})
export class AdminTeamsNewPersonnel {
  ...
  setList() {
    const list: Item[] = [];
    list.push({id: 'new', value: 'Add New Team Person'});
